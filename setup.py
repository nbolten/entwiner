...
setup(
    ...
    package_dir={"": "."},
    package_data={"entwiner": ["geopackage_extensions/*.swp"]},
    install_requires=['click==7.*,>=7.0.0', 'fiona==1.*,>=1.8.13', 'geomet==0.*,>=0.2.1', 'networkx==2.*,>=2.4.0', 'partridge==1.*,>=1.1.1', 'pyproj==2.*,>=2.4.2', 'shapely==1.*,>=1.6.4'],
